class TerrainConfig:
    ...
    horizontal_scale = 0.05  # Horizontal scale [m]
    ...
    terrain_types = ['smooth_slope', 'stairs_down', 'stairs_up', 'discrete', 'stepping_stones']

    # ---------------------------------------------------------------------------
    # Trimesh Specific Settings
    # ---------------------------------------------------------------------------
    slope_threshold = 0.45  # For 'trimesh' type: slopes above this threshold will be corrected to vertical surfaces
